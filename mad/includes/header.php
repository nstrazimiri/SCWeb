...
<head>
	...
	<link rel="icon" href="../images/madicon.jpg">
	<title>St.Clair | Mobile Applications Development</title>

	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="../css/bootstrap.min.css">
	<link rel="stylesheet prefetch" href="//maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
	<link rel="stylesheet" href="../css/mad.css?v=<?=date('i s h d m y Y ')?>">
</head>
<body>
<div class=" main">
	<header>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light bg-mad">
